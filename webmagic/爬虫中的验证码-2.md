# 面对验证码问题的解决办法
~~~java
package com.mask.sougou.certificate;
...
public class TeacherPageProcessor implements PageProcessor {
    ...
    // 证书名称
    private static final String professional_qualification = "教师资格证";
    ...
    public void parseVerifyCodeCheck(Page page, Map<String, Object> extra) throws MalformedURLException {
        ...
        if (/*certexist.equals("true") &&*/ success.equals("true")) {
            // 请求时间戳 需要作为参数拼接
            String dataUrl = QUERY_DATA_URL.replace("{idNum}", "11").replace("{certNum}", AppConst.CERTIFICATE_NUM).replace("{time}", System.currentTimeMillis()+"");
    ...
    public void parseVerifyCode(Page page, Map<String, Object> extra) throws Exception {
        ...
        if (jsonObject.get("err").equals("0")){
            ...
            param.put("name", "111");
            param.put("idNo", AppConst.ID_NUM);
            param.put("certNo", AppConst.CERTIFICATE_NUM);
            Map<String, Object> map = new HashMap<>();
            map.putAll(extra);
...
public class TeacherSpider {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Spider.create(new TeacherPageProcessor())
                .addRequest(request)
     ...
     * 设置请求头
     */
    public static void setGetHeaders(Request request) throws Exception {
        request.addHeader("Accept", "image/avif,image/webp,image/apng,image/svg+xml,image/*,*/*;q=0.8");
        request.addHeader("Accept-Encoding", "gzip, deflate");
        request.addHeader("Accept-Language", "zh-CN,zh;q=0.9");
        request.addHeader("Connection", "keep-alive");
        request.addHeader("Host", "appquery.neea.edu.cn");
        request.addHeader("User-Agent", "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/92.0.4515.107 Safari/537.36");
        request.addHeader("Upgrade-Insecure-Requests", "1");
        request.addHeader("Cookie", "Hm_lvt_dc1d69ab90346d48ee02f18510292577=1628579042,1628582440,1628651709,1628834637; verify=8980a75d1fa62e51641152030bb0ceaa; Hm_lpvt_dc1d69ab90346d48ee02f18510292577=1629182021");
        request.addHeader("Referer", "http://cjcx.neea.edu.cn/");
    }
